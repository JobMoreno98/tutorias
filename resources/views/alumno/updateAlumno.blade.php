    ...
    <div class="container">
        @if(Auth::user()->id == $alumno->IdUser || Auth::user()->role == 'admin')
            ...
            <div class="row">
                ...
                <form action="{{ route ('updateAlumno', ['alumno_id' =>$alumno->IdUser]) }}" method="post" enctype="multipart/form-data" class="col-md-12 d-flex flex-wrap justify-content-start align-items-center">
                    {!! csrf_field() !!}
                    @if($errors->any())
                    ...
                    <div class="form-group p-1 col-md-3 col-xs-12">
