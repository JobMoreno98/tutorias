                            ...
                            <table class="table table-bordered">
                                ...
                                @foreach($listaInscritos as $listaInscrito)
                                    <tr>
                                        ...
                                        <td><a href="{{ route('fichaAlumno', ['alumno_id' => $listaInscrito->user_id]) }}" class="btn btn-sm btn-success">Ver Expediente</a></td>
                                        <td><a href="{{ route('cancelarTutoria', ['alumno_id' => Auth::user()->id, 'inscripcion_id' => $listaInscrito->inscripcion_id]) }}" class="btn btn-sm btn-danger">Desincribirse</a></td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>
